...
COOKIE_FILE="cookies_message.txt"
...
#Output file name
OUTFILE="${LOGFOLDER}BMC_Dump.${BmcPrime}.dat"

commandString="curl -k -b ${COOKIE_FILE} -X GET -H \"X-CSRFTOKEN: ${csrfToken}\" -H \"Cache-Control: no-cache\" -H content-type:application/json \"https://${BmcIpAddress}/api/logs/console-file\" > ${OUTFILE}"
